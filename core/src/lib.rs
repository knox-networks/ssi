...
pub fn verify_data_integrity_proof<S: ssi_signature::suite::Signature>(
    _doc: serde_json::Value,
    _resolver: &impl DIDResolver,
    _verifier: &impl ssi_signature::verifier::DIDVerifier<S>,
...
pub fn verify_presentation<S: ssi_signature::suite::Signature>(
    _doc: serde_json::Value,
    _resolver: &impl DIDResolver,
    _verifier: &impl ssi_signature::verifier::DIDVerifier<S>,
) -> Result<bool, Box<dyn std::error::Error>> {
