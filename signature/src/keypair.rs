pub trait KeyPair: core::fmt::Debug + Sized {
    fn get_public_key_encoded(&mut self) -> String where Self: Sized;
    fn get_private_key_encoded(&mut self) -> String where Self: Sized;
    fn get_public_key(&self) -> ed25519_zebra::VerificationKey where Self: Sized;
    fn get_private_key(&self) -> ed25519_zebra::SigningKey where Self: Sized;
}
